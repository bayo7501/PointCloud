...
namespace FingerLime {
    public class DepthArray {
        ...
        /// <param name="xyPoints">設定データ(公共のX軸リスト×Y軸リスト)</param>
        /// <param name="shiftOrigin"></param>
        /// <param name="meshPitch"></param>
        ...
        public void Create() {
            ...
            try {
                ...
                for (int i = 0; i < rectangles.Count; i++) {
                    ...
                    //Rectangle minify = new Rectangle(minifyA, minifyB, minifyC, minifyD);
                    ...
                    for (int y = 0; y < meshLengthY; y++) {
                        ...
                        //if (seekY > meshLength * meshPitch + shiftOrigin.Y + meshPitch) {
                        //    break;
                        //}
                        ...
                        for (int x = 0; x < meshLengthX; x++) {
                            ...
                            //if (seekX > meshLength * meshPitch + shiftOrigin.X + meshPitch) {
                            //    break;
                            //}
                            ...
                            if (CrossCount(seekX, seekY, rectangleX, rectangleY) != 0) {
                                ...
                                if (ans == 0) {
                                    ...
                                    if (span == 0) {
                                        ...
                                        depths[(int)(Math.Floor((seekY - shiftOrigin.Y) / meshPitch) * meshLength + Math.Floor((seekX - shiftOrigin.X) / meshPitch))] = (short)(A.D * 10.0);
                                        continue;
                                    } else {
                                        // 点A-点C間の点Pの深さ
                                        double d = span * ap / ac;
                                        ...
                                        depths[(int)(Math.Floor((seekY - shiftOrigin.Y) / meshPitch) * meshLength + Math.Floor((seekX - shiftOrigin.X) / meshPitch))] = (short)(depth * 10.0);
                                        continue;
                                    }
                                    ...
                                    if (Intersection(A, C, _B, P, out XYD O)) {
                                        ...
                                        if (span == 0) {
                                            ...
                                            if (span == 0) {
                                                ...
                                                depths[(int)(Math.Floor((seekY - shiftOrigin.Y) / meshPitch) * meshLength + Math.Floor((seekX - shiftOrigin.X) / meshPitch))] = (short)(O.D * 10.0);
                                                continue;
                                            } else {
                                                d = span * po / bo;
                                                if (O.D > _B.D) {
